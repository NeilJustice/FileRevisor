...
curl https://raw.githubusercontent.com/NeilJustice/ZenUnitAndMetalMock/main/MetalMock/MetalMock.h --create-dirs -o "$TRAVIS_BUILD_DIR/ZenUnit/MetalMock.h"
ninja -v
./libFileRevisorTests/libFileRevisorTests --test-runs=5 --random-test-ordering --exit-1-if-tests-skipped
