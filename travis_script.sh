...
curl https://raw.githubusercontent.com/NeilJustice/ZenUnitAndMetalMock/main/ZenUnitAndMetalMock/ZenUnit.h --create-dirs -o "$TRAVIS_BUILD_DIR/ZenUnitAndMetalMock/ZenUnit.h"
curl https://raw.githubusercontent.com/NeilJustice/ZenUnitAndMetalMock/main/ZenUnitAndMetalMock/MetalMock.h --create-dirs -o "$TRAVIS_BUILD_DIR/ZenUnitAndMetalMock/MetalMock.h"
...
./libFileRevisorTests/libFileRevisorTests --test-runs=5 --random --exit-1-if-tests-skipped
