...
def run_all_tests_with_coverage(testsProjectName: str, omitPattern: str) -> None:
   ...
   Process.fail_fast_run(f'python -m coverage html --omit="{omitPattern}" --directory={testsProjectName}/CodeCoverageHTMLReport --title="{testsProjectName} Code Coverage"')
   if reportExitCode == 0:
