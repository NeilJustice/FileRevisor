...
private:
   ...
   using  _oneExtraArgMemberForEacher_DeleteDirectoryType =
      OneArgMemberFunctionForEacher<DeleteDirectorySubProgram, string>;
   ...
   using _parallelTwoArgMemberFunctionForEacher_DeleteDirectoryType =
      ParallelOneArgMemberFunctionForEacher<DeleteDirectorySubProgram, string>;
   ...
   using _tryCatchCaller_DeleteDirectoryType =
      VoidOneArgTryCatchCaller<DeleteDirectorySubProgram, const string&>;
   unique_ptr<const _tryCatchCaller_DeleteDirectoryType> _tryCatchCaller_DeleteDirectory;
   // Constant Components
   unique_ptr<const DirectoryDeleter> _directoryDeleter;
public:
