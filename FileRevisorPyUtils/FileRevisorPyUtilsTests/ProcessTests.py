...
from FileRevisorPyUtils import Process, UnitTester, Random
...
class ProcessTests(unittest.TestCase):
   ...
   @patch('FileRevisorPyUtils.Process.bytes_to_utf8', spec_set=True)
   ...
   @patch('builtins.print', spec_set=True)
   @patch('FileRevisorPyUtils.Process.cross_platform_subprocess_call', spec_set=True)
