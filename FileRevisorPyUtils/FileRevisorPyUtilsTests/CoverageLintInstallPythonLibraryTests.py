...
import docopt
from FileRevisorPyUtils import CoverageLintInstallPythonLibrary, Python, Process, UnitTester, Random # pylint:disable=no-name-in-module
...
CoverageLintInstallPythonLibrary.__doc__)
   ...
   @patch('FileRevisorPyUtils.Python.flake8_all', spec_set=True)
   @patch('FileRevisorPyUtils.Python.pylint_all', spec_set=True)
