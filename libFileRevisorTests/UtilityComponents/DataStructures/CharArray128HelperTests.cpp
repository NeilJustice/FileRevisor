...
CharArray128Helper _charArray128Helper;

TEST(ArrayContains0_MaximumNumberOfElementsToCompareIs0_ReturnsFalse)
{
   const array<char, 128> chars = ZenUnit::RandomStdArray<char, 128>();
   //
   const bool arrayContainsElement = _charArray128Helper.ArrayContains0(chars, 0);
   //
...
{
   array<char, 128> chars = ZenUnit::RandomStdArray<char, 128>();
   chars[0] = ZenUnit::RandomNotEqualTo<char>(0);
   //
   const bool arrayContains0 = _charArray128Helper.ArrayContains0(chars, 1);
   //
...
TEST(ArrayContains0_MaximumNumberOfElementsToCompareIs2_Char0IsNot0_Char1IsNot0_ReturnsFalse)
{
   ...
   //
   const bool arrayContains0 = _charArray128Helper.ArrayContains0(chars, 2);
   //
   IS_FALSE(arrayContains0);
}
...
{
   array<char, 128> chars{};
   std::iota(chars.begin(), chars.end(), static_cast<char>(1));
   //
   const bool arrayContains0 = _charArray128Helper.ArrayContains0(chars, 64);
   //
   IS_FALSE(arrayContains0);
}
...
RUN_TESTS(CharArray128HelperTests)
