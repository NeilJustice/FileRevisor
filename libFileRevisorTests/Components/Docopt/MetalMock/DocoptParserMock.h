...
public:
   ...
   METALMOCK_NONVOID4_CONST(string, GetProgramModeSpecificRequiredString, const DocoptMapType&, unsigned, unsigned, const string&)
   ...
   METALMOCK_NONVOID3_CONST(string, GetOptionalStringWithDefaultValue, const DocoptMapType&, string_view, string_view)
};
