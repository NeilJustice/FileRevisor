...
class VoidFourArgMemberFunctionCallerMock : public Zen::Mock<VoidFourArgFunctionCaller<Arg1Type, Arg2Type, Arg3Type, Arg4Type>>
{
public:
   using VoidFourArgFunctionType = void (*)(Arg1Type, Arg2Type, Arg3Type, Arg4Type);
   ZENMOCK_VOID5_CONST(Call, VoidFourArgFunctionType, Arg1Type, Arg2Type, Arg3Type, Arg4Type)
};
