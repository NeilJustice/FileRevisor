...
public:
   ...
   {
      p_console.reset(p_consoleMock = new ConsoleMock);
   }
...
#endif
   // Constant Components
   _recursiveFileDeleter.p_console.reset(p_consoleMock = new ConsoleMock);
...
#endif
   // Constant Components
   DELETE_TO_ASSERT_NEWED(recursiveFileDeleter.p_console);
