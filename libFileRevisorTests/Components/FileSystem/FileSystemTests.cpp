...
#include "libFileRevisorTests/UtilityComponents/Iteration/ForEach/MetalMock/ThreeArgMemberForEacherMock.h"
...
// Deletes
AFACT(DeleteTopLevelFilesAndEmptyDirectoriesInDirectory_IfWindowsRemovesReadOnlyFlagsFromTopLevelFiles_DeletesTopLevelFiles_DeletesTopLevelEmptyDirectories)
...
using _foreacher_DeleteFileOrDirectoryMockType = ThreeArgMemberForEacherMock<FileSystem, fs::path, bool, bool>;
...
TEST(DeleteTopLevelFilesAndEmptyDirectoriesInDirectory_IfWindowsRemovesReadOnlyFlagsFromTopLevelFiles_DeletesTopLevelFiles_DeletesTopLevelEmptyDirectories)
{
