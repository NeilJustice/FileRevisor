...
if(UNIX)
   ...
   set(MetalMockIncludeDirectory /usr/local/include/MetalMock)
elseif(MSVC)
   set(ZenUnitIncludeDirectory C:\\include\\ZenUnit)
   set(MetalMockIncludeDirectory C:\\include\\MetalMock)
endif()
