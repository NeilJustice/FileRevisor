...
from FileRevisorPyUtils import Python, Process, UnitTester, Random
...
class PythonTests(unittest.TestCase):
   ...
   @patch('FileRevisorPyUtils.Process.run_and_get_exit_code', spec_set=True)
   ...
   def pylint_all_LinuxCallsMapParallelPylintFileWithAllPyFilePaths_WindowsCallsMapSequential_test(self):
      ...
      @patch('FileRevisorPyUtils.Process.run_parallel_processpoolexecutor', spec_set=True)
      @patch('FileRevisorPyUtils.Process.run_parallel_processthread', spec_set=True)
