...
from FileRevisorDevOpsPython import Process, Python
...
class PythonTests(unittest.TestCase):
   ...
   @patch('FileRevisorDevOpsPython.Process.run_and_get_exit_code', spec_set=True)
   ...
   def test_run_pylint_on_all_files_in_parallel_LinuxCallsMapParallelPylintFileWithAllPyFilePaths_WindowsCallsMapSequential(self):
      ...
      @patch('FileRevisorDevOpsPython.Process.run_parallel_processpoolexecutor', spec_set=True)
      @patch('FileRevisorDevOpsPython.Process.run_parallel_processthread', spec_set=True)
